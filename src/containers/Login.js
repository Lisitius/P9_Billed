...
export default class Login {
  ...
  handleSubmitAdmin = (e) => {
    ...
    const user = {
      type: "Admin",
      email: e.target.querySelector(`input[data-testid="admin-email-input"]`) //bad query selector was employee
        .value,
      password: e.target.querySelector(
        `input[data-testid="admin-password-input"]` //bad query selector was employee
      ).value,
      status: "connected",
    };
    this.localStorage.setItem("user", JSON.stringify(user));
